  ...
  .donate
    ...
    v-container
      v-row(justify='center')
        v-col(cols='12')
          .text-center.py-3(style='max-width: 1000px; margin: 0 auto;')
        ...
        v-col(cols='12', md='6')
          .donate-item.animated.fadeInUp
            ...
            .px-4
              ...
              div
                v-chip.ml-0(color='grey-lighten-4', size='small', label)
                  .text-caption Monthly
                v-chip.ml-0(color='grey-lighten-4', size='small', label)
                  .text-caption One-time
                v-chip.ml-0(color='grey-lighten-4', size='small', label)
                  .text-caption Public
                v-chip.ml-0(color='grey-lighten-4', size='small', label)
                  .text-caption Anonymous
